...
def make_fileset(samples, ntuple_version, max_files=-1, location_cfg="../configs/ntuple_locations.yaml"):
    ...
    ntuple_versions = ["ffntuple_v2", "ffntuple_v4", "llpNanoAOD_v1", "llpNanoAOD_v1_merged", "llpNanoAOD_v2", "llpNanoAOD_v2_merged", "ffntuple_official", "ffntuple_private", 
                        "llpNanoAOD_v2_new", "llpNanoAOD_v2_new_merged"]
