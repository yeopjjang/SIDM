...
obj_cut_defs = {
    ...
    "dsaMuons": {
       ...
       # "no PF match" : lambda objs, dsa: dsa.muonMatch1/dsa.nSegments < 0.667,
        ...
        "segmatch veto": lambda objs, dsa: ak.all((objs["dsaMuons"].matched_muons.numMatch < 1) | (ak.is_none(objs["dsaMuons"].matched_muons, axis=2)), axis=2),
        "segmatch veto + charge": lambda objs, dsa: ak.all((objs["dsaMuons"].matched_muons.numMatch < 1) | (objs["dsaMuons"].charge[:,:,None] != objs["dsaMuons"].matched_muons.charge) | (ak.is_none(objs["dsaMuons"].matched_muons, axis=2)), axis=2),
        "segmatch veto + dR outer": lambda objs, dsa: ak.all((objs["dsaMuons"].matched_muons.numMatch < 1) | (dR_outer(objs["dsaMuons"][:,:,None], objs["dsaMuons"].matched_muons) > 0.1) | (ak.is_none(objs["dsaMuons"].matched_muons, axis=2)), axis=2),
        "segmatch veto + num seg": lambda objs, dsa: ak.all((objs["dsaMuons"].matched_muons.numMatch < 1) | (objs["dsaMuons"].matched_muons.numMatch/(objs["dsaMuons"].nSegments[:,:,None]) < 0.34) | (ak.is_none(objs["dsaMuons"].matched_muons, axis=2)), axis=2),
        "segmatch veto + dR outer + num seg": lambda objs: ak.all((objs["dsaMuons"].matched_muons.numMatch < 1) | (dR_outer(objs["dsaMuons"][:,:,None], objs["dsaMuons"].matched_muons) > 0.1) |
                                    (objs["dsaMuons"].matched_muons.numMatch/(objs["dsaMuons"].nSegments[:,:,None]) < 0.34) | (ak.is_none(objs["dsaMuons"].matched_muons, axis=2)), axis=2),
        "all": lambda objs, dsa: ak.all((objs["dsaMuons"].matched_muons.numMatch < 1) | (objs["dsaMuons"].charge[:,:,None] != objs["dsaMuons"].matched_muons.charge) | (dR_outer(objs["dsaMuons"][:,:,None], objs["dsaMuons"].matched_muons) > 0.1) |
                                    (objs["dsaMuons"].matched_muons.numMatch/(objs["dsaMuons"].nSegments[:,:,None]) < 0.34) | (ak.is_none(objs["dsaMuons"].matched_muons, axis=2)), axis=2),
    },
}
