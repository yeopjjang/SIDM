...
evt_cut_defs = {
    ...
    "LJ-LJ dPhi >= 2": lambda objs: abs(objs["ljs"][:, 0].delta_phi(objs["ljs"][:, 1])) >= 2.0,
    "LJ-LJ dPhi < 2": lambda objs: abs(objs["ljs"][:, 0].delta_phi(objs["ljs"][:, 1])) < 2.0,
    "LJ-LJ invariant mass >= 150 GeV": lambda objs: objs["ljs"][:, :2].sum().mass >= 150,
    "LJ-LJ invariant mass < 150 GeV": lambda objs: objs["ljs"][:, :2].sum().mass < 150,
    "muLJ-egmLJ dPhi >= 2": lambda objs: abs(objs["mu_ljs"][:, 0].delta_phi(objs["egm_ljs"][:, 0])) >= 2.0,
    "muLJ-egmLJ dPhi < 2": lambda objs: abs(objs["mu_ljs"][:, 0].delta_phi(objs["egm_ljs"][:, 0])) < 2.0,
    "muLJ-egmLJ invariant mass >= 150 GeV": lambda objs: (objs["mu_ljs"][:, 0] + objs["egm_ljs"][:, 0]).mass >= 150,
    "muLJ-egmLJ invariant mass < 150 GeV": lambda objs: (objs["mu_ljs"][:, 0] + objs["egm_ljs"][:, 0]).mass < 150,
    "muLJ-muLJ dPhi >= 2": lambda objs: abs(objs["mu_ljs"][:, 0].delta_phi(objs["mu_ljs"][:, 1])) >= 2.0,
    "muLJ-muLJ dPhi < 2": lambda objs: abs(objs["mu_ljs"][:, 0].delta_phi(objs["mu_ljs"][:, 1])) < 2.0,
    "muLJ-muLJ invariant mass >= 150 GeV": lambda objs: objs["mu_ljs"][:, :2].sum().mass >= 150,
    "muLJ-muLJ invariant mass < 150 GeV": lambda objs: objs["mu_ljs"][:, :2].sum().mass < 150,
