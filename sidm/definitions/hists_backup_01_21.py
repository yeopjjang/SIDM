...
# define counters
counter_defs = {
    "# of Events": lambda objs: ak.count(objs["pvs"]),
...
hist_defs = {
    ...
    "subleading_mu_lj_isolation": h.Histogram(
        [
            h.Axis(hist.axis.Regular(50, 0, 2, name="subleading_mu_lj_isolation",
    ...
    "leading_lj_isolation2": h.Histogram(
        [
            h.Axis(hist.axis.Regular(50, 0, 1.5, name="leading_lj_isolation2",
                   label="Leading LJ Isolation2"),
    ...
    "subleading_lj_isolation2": h.Histogram(
        [
            h.Axis(hist.axis.Regular(50, 0, 1.5, name="subleading_lj_isolation2",
                   label="Subleading LJ Isolation2"),
    ...
    "leading_mu_lj_isolation2": h.Histogram(
        [
            h.Axis(hist.axis.Regular(50, 0, 2, name="leading_mu_lj_isolation2",
                   label="Leading Mu-LJ Isolation2"),
    ...
    "subleading_mu_lj_isolation2": h.Histogram(
        [
            h.Axis(hist.axis.Regular(50, 0, 2, name="subleading_mu_lj_isolation2",
                   label="Subleading Mu-LJ Isolation2"),
    ...
    "egm_lj_isolation2": h.Histogram(
        [
            h.Axis(hist.axis.Regular(50, 0, 2, name="egm_lj_isolation2",
                   label="EGM-LJ LJ Isolation2"),
